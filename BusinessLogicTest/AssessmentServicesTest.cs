...
namespace BusinessLogicTest
{
    public class AssessmentServicesTest
    {
        ...
        {
            //arrange
            //TODO: Я не совсем понимаю как правильно указать тут путь к этому файлу в WebApplication
            IConfiguration Configuration = new ConfigurationBuilder()
                .AddJsonFile("appsettings.json")
                .Build();
            AssessmentServices assessmentServices = new AssessmentServices(new Mock<ILogger<AssessmentServices>>().Object, 
